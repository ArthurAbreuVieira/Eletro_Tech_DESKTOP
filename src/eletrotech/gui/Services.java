...
public class Services extends javax.swing.JPanel {
    ...
    public Services() throws IOException {
        ...
        eletrotech.api.Service[] services  = eletrotech.api.API.getServices();
        
        for(int i = services.length-1;i>=0;i--) {
            listPanel.add(new ServiceItem(services[i]));
        }
    ...
    private void initComponents() {
        ...
        jPanel2.setMinimumSize(new java.awt.Dimension(966, 35));
        jPanel2.setPreferredSize(new java.awt.Dimension(966, 35));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            Home.showCard("ServiceForm", new ServiceForm());
