...
public class ServiceItem extends javax.swing.JPanel {
    private eletrotech.api.Service service;
    /**
     * Creates new form ScheduleItem
     */
    public ServiceItem(eletrotech.api.Service _service) {
        initComponents();
        
        service = _service;
        String disponibilityText = service.getDisponibility() == 0 ?  "Indisponivel" : "Disponivel"; 
        name.setText(service.getName());
        disponibility.setText(disponibilityText);
    }
    /**
    ...
    private void initComponents() {
        ...
        disponibility = new javax.swing.JLabel();
        ...
        disponibility.setForeground(new java.awt.Color(0, 102, 51));
        disponibility.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        disponibility.setText("{DISPONIBILITY}");

        javax.swing.GroupLayout jPanel15Layout = new javax.swing.GroupLayout(jPanel15);
        jPanel15.setLayout(jPanel15Layout);
        jPanel15Layout.setHorizontalGroup(
            jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(disponibility, javax.swing.GroupLayout.DEFAULT_SIZE, 139, Short.MAX_VALUE)
        ...
        jPanel15Layout.setVerticalGroup(
            ...
            .addGroup(jPanel15Layout.createSequentialGroup()
                ...
                .addComponent(disponibility, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        try {
            Home.showCard("ServiceDetails", new ServiceDetails(service));
    ...
    private javax.swing.JLabel disponibility;
