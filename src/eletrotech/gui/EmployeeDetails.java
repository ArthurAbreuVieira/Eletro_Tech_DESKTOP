...
public class EmployeeDetails extends javax.swing.JPanel {
    ...
    public EmployeeDetails(eletrotech.api.Employee employee) throws IOException {
        initComponents();
        titleLabel.setText(employee.getUsername());
        
                
        idField.setText(Integer.toString(employee.getId()));
        nameField.setText(employee.getUsername());
        emailField.setText(employee.getEmail());
        addressField.setText(employee.getAddress());
        int selectedIndex = employee.getRole().equals("admin") ? 0 : 1;
    ...
    private void initComponents() {
        ...
        titleLabel.setText("{employee_name}");
        ...
        idLabel.setText("ID:");
        idLabel.setMaximumSize(new java.awt.Dimension(66, 20));
        idLabel.setMinimumSize(new java.awt.Dimension(66, 20));
        idLabel.setPreferredSize(new java.awt.Dimension(66, 20));
        jPanel7.add(idLabel);
